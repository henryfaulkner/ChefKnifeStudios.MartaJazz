...
{
    public string ElementId { get; } = $"cks-maplibre-{Guid.NewGuid()}".ToLower();
    ...
    [Parameter] public EventCallback<MapLibre> OnMapReady { get; set; }
    [Parameter] public EventCallback<MapLibre> OnMapBodyClicked { get; set; }
    [Parameter] public EventCallback<(MapLibre Map, string VehicleId)> OnBusMarkerClicked { get; set; }
